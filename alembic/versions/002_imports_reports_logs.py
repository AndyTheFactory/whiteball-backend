...
#     op.create_index("ix_import_batches_company_period", "import_batches",
...
#         sa.Column("event_type", sa.String(100), nullable=True),  # import_started,
#                                                                  # report_generated, login_failed, etc.
#         sa.Column(
